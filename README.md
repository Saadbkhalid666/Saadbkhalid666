...
- 🎯 Focused on clean architecture, intuitive UX, and code that's actually maintainable six months later
- 📈 1000+ GitHub contributions in 2025 — still climbing
- 🧠 Started coding March 2024 → full MERN stack by early 2025 → Django, Flask, Angular, TypeScript by mid-2025
...
<img src="https://skillicons.dev/icons?i=js,ts,react,nextjs,nodejs,express,mongodb,py,django,flask,redux,tailwind,threejs,figma,git,github,vercel,html,css&theme=dark" />

</div>

<div align="center">

`Socket.IO`&nbsp;&nbsp;•&nbsp;&nbsp;`Redux Toolkit`&nbsp;&nbsp;•&nbsp;&nbsp;`GSAP`&nbsp;&nbsp;•&nbsp;&nbsp;`Three.js`&nbsp;&nbsp;•&nbsp;&nbsp;`TensorFlow`&nbsp;&nbsp;•&nbsp;&nbsp;`Gemini API`&nbsp;&nbsp;•&nbsp;&nbsp;`JWT`&nbsp;&nbsp;•&nbsp;&nbsp;`SQLite`
...
<img src="https://raw.githubusercontent.com/saadbkhalid666/saadbkhalid666/output/github-contribution-grid-snake-dark.svg" width="100%"/>
